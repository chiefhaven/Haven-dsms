...
<html>
<head>
    <link rel="stylesheet" id="css-main" href="{{ public_path(mix('css/dashmix.css')) }}  }}">
    <style>
        @page {
            margin: 25px;
        }
...
<div class="container invoice">
    ...
    <P>Am writing to seek your assistance for {{$student->fname}} {{$student->sname}} to take the practical road test. {{$student->fname}} {{$student->sname}} is one of our students here at DARON DRIVING SCHOOL and has completed his driving lessons and is ready for the road test.</P>
